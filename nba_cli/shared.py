...
AVAILABLE_COMMANDS = (
    ...
    "train_outcome_ml, train_projection_ml, train_projection_ml_per_stat, train_quantile_projection, promote_projection_ml, backtest, live_projection, risk_metrics, dedup_journal"
)
